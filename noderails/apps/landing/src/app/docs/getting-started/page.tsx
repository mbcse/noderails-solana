  ...
  return (
    <>
      ...
      <ol>
        ...
        <li><strong>A connected wallet</strong> where you want to receive payments. NodeRails supports <strong>EVM</strong> wallets (<code>0x…</code>) and <strong>Solana</strong> wallets (base58 public key). Use the merchant dashboard to connect and verify the address for each network. Funds settle here after the timelock period.</li>
      ...
      <p>
        ...
        mainnet-beta <code>103</code>, testnet <code>101</code>, devnet <code>102</code> (enabled per deployment).
      </p>
