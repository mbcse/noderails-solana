...
const checkoutUrl = \`https://pay.noderails.com/checkout/\${session.id}\`;`}
      ...
      <p>
        ...
        a wallet (EVM via WalletConnect-compatible wallets, Solana via Phantom / Solflare and similar adapters),
...
console.log(expired.status); // "EXPIRED"`}
  ...
  CheckoutSessionListParams,
      ...
      <ResponseTable title="CheckoutSession (create)">
        ...
        <ResponseField name="allowedTokens" type="string | string[]" description="&quot;ALL&quot; or array of symbols / token keys (incl. SOL-103, USDC-103)" />
