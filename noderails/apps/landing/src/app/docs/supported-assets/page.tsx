  ...
  return (
    <>
      ...
      <Callout type="info" title="Quick integration tip">
        ...
        Solana clusters <code>103</code> (mainnet), <code>102</code> (devnet), <code>101</code> (testnet). Pass <code>allowedTokens</code> as symbols or token keys (e.g. <code>USDC</code>, <code>USDC-8453</code>, <code>SOL-103</code>).
        See the <Link href="/docs/getting-started">Quick Start guide</Link> for usage examples.
      </Callout>
